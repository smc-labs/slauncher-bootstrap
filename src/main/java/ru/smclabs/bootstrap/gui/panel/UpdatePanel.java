...
public class UpdatePanel extends Panel {
    ...
    public UpdatePanel(ThemeManager themeManager) {
        ...
        add(fileDownloading = new FileDownloading(themeManager, this));
    ...
    private int calcWidth() {
        return GuiService.FRAME_WIDTH - BackgroundPanel.PADDING_X * 2;
    }

    private int calcHeight(int posY) {
        return GuiService.FRAME_HEIGHT - posY - BackgroundPanel.PADDING_Y;
    }
